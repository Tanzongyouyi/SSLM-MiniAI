...
def main():
    ...
    # 加载预训练权重
    checkpoint = torch.load('checkpoints/model_epoch_14.pt', map_location=device)
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(checkpoint, f'checkpoints/model_epoch_{epoch+15}.pt')  # 保存为epoch11开始
